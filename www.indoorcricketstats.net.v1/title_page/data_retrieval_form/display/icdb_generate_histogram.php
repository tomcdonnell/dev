...
*/
 ...
 for ($i = 0; $i <= $n_columns; ++$i)
 {
    ...
    $y = $chartMaxY + 5;
    imageline($image, $x, $chartMaxY, $x, $y, $colorBlack);
 }
 ...
 for ($i = $startColumn; $i < $n_columns; $i += $n_columnsPerLabel)
 {
    ...
    printXcenteredHorizTextString($image, $fontSize,
                                  ...
                                  $chartMaxY + 5, $textString, $colorBlack);
 }
 ...
 imagefilledrectangle($image, $x_left, $y_bottom, $x_right, $y_top, $colorDarkGreen);
...
*/
 ...
 imageline($image, $x_dataMean, $chartMinY, $x_dataMean, $chartMaxY, $colorRed);
